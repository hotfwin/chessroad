...
class BoardPainter extends PainterBase {
  ...
  static doPaint(
    ...
    for (var i = 0; i < 8; i++) {
      ...
      canvas.drawLine(Offset(left + squareSide * i, top + squareSide * 5),
          Offset(left + squareSide * i, top + squareSide * 9), paint);
    }
